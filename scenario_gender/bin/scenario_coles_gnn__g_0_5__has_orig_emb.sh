...
PYTHONPATH=.. python -m ptls.pl_train_module \
    ...
    model_path="models/coles_gnn__g_0_5__has_orig_emb__sample_2__model.p" \
    logger_name="coles_gnn__g_0_5__has_orig_emb_2"  \
...
PYTHONPATH=.. python -m pl_inference_with_client_id    \
    model_path="models/coles_gnn__g_0_5__has_orig_emb__sample_2__model.p" \
    embed_file_name="coles_gnn__g_0_5__has_orig_emb__sample_2__embeddings" \
