...
SPARK_LOCAL_IP="127.0.0.1" spark-submit \
    ...
    --cols_log_norm "price" \
    --cols_no_transform "url_host" \
    --cols_to_float "request_cnt" \
    --target_files public_train.parquet \
    --col_target "is_male" "age" \
    --test_size 0.1 \
    --output_train_path "data/with_url/train_trx_file.parquet" \
    --output_test_path "data/with_url/test_trx_file.parquet" \
    --output_test_ids_path "data/with_url/test_ids_file.csv" \
    --log_file "results/dataset_age_pred_file_with_url.txt"
